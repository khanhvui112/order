 ...
 * https://github.com/chart/js/Chart./js/blob/master/LICENSE.md
 */
		...
		update: function(reset) {
			...
			if (showLine) {
				...
				line._model = {
					...
					// to https://github.com/chart/js/Chart./js/issues/2435#issuecomment-216718158
...
module.exports = function(Chart) {
	...
	function initCanvas(canvas, config) {
		...
		// https://github.com/chart/js/Chart./js/issues/2538
	...
	function acquireContext(item, config) {
		...
		if (item instanceof HTMLCanvasElement) {
			...
			// https://github.com/chart/js/Chart./js/issues/2807
	...
	Chart.Controller = function(item, config, instance) {
		...
		// See https://github.com/chart/js/Chart./js/issues/2210
...
module.exports = function(Chart) {
	...
	helpers.retinaScale = function(chart) {
		...
		// See https://github.com/chart/js/Chart./js/issues/3575
	...
	helpers.addResizeListener = function(node, callback) {
		...
		// https://github.com/chart/js/Chart./js/issues/3090
		iframe.tabIndex = -1;
		...
		// https://github.com/chart/js/Chart./js/issues/3521
